...
Diseñado para ingenieros que buscan agilidad en el despliegue y operación de infraestructuras Cloud Native.  Stack Kitchen permite desplegar desde entornos de pruebas (Sandbox) hasta arquitecturas de **Alta Disponibilidad** (HA) en cuestión de minutos. 
...
-   ### Core <br>Infrastructure
    ...
    <a href="https://idp-gt.github.io/platform-architect/modules/base/1-provisioning/" class="md-button">Conoce Más</a>
...
-   ### Data Platforms<br>& Pipelines
    ...
    <a href="https://idp-gt.github.io/platform-architect/modules/data/iac/" class="md-button">Conoce Más</a>
...
-   ### AI & MLOps
    ...
    <a href="https://idp-gt.github.io/platform-architect/modules/ia/components/" class="md-button">Conoce Más</a>
...
![Cloud Native Landscape](assets/landscape2.png){ align=center width="100%" }
