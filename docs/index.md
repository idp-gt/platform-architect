...
-   ### Core <br>Infrastructure
    ...
    <a href="modules/base/1-provisioning/" class="md-button">Conoce Más</a>
...
-   ### Data Platforms<br>& Pipelines
    ...
    <a href="modules/data/iac/" class="md-button">Conoce Más</a>
...
-   ### AI & MLOps
    ...
    <a href="modules/ia/components/" class="md-button">Conoce Más</a>
